...
USER_AGENT = "openclaw-repos-catalog"
AUTO_KEYWORD_TERMS: tuple[tuple[str, tuple[str, ...]], ...] = (
    ("OpenClaw", ("openclaw", "clawd", "lobster")),
    ("Skills", ("skill", "skills")),
...
SUBSTRING_KEYWORDS = {"OpenClaw", "MCP", "ACP", "CLI", "Nix", "AI"}
...
CLUSTERS: tuple[Cluster, ...] = (
    Cluster(
        ...
        "Core Runtime & Assistant",
        "The OpenClaw personal assistant, gateway, onboard flow, and the lobster that actually does things.",
        "orange",
        (
            "assistant",
            "gateway",
    ...
    Cluster(
        "skills-plugins-hub",
        "Skills, Plugins & Hub",
        "Skill registries, community plugins, workflow shells, and the ClawHub directory.",
        "purple",
        (
            "clawhub",
            "directory",
    ...
    Cluster(
        ...
        "Agent Client Protocol sessions, MCP TypeScript APIs, and headless protocol clients.",
        "cyan",
        (
            "acp",
    ...
    Cluster(
        "review-automation",
        "Review, Sweeping & Automation",
        "PR review bots, issue sweepers, remote test runners, and maintainer automation.",
        "green",
        (
            "automation",
            "bot",
    ...
    Cluster(
        "messaging-workspace-clis",
        "Messaging, Workspace & Social CLIs",
        "WhatsApp, iMessage, Discord, Slack, Google Workspace, reminders, and other agent-facing CLIs.",
        "yellow",
        (
            "cli",
            "discord",
    ...
    Cluster(
        ...
        "Windows companion nodes, macOS screenshot/MCP tools, accessibility wrappers, and fleet control.",
        "red",
        (
            "accessibility",
            "companion",
    ...
    Cluster(
        "packaging-nix-infra",
        "Packaging, Nix & Infrastructure",
        "Nix packages, Ansible installers, Homebrew taps, and host/infra modules for running OpenClaw.",
        "blue",
        (
            "ansible",
            "homebrew",
...
def cluster_repo(repo: dict[str, Any]) -> Cluster:
    ...
    name_overrides = {
        ...
        "acpx": "agent-protocols-mcp",
        "mcporter": "agent-protocols-mcp",
        "clawpatch": "review-automation",
        "clawsweeper": "review-automation",
        "crabbox": "review-automation",
        "wacli": "messaging-workspace-clis",
        ...
        "goplaces": "messaging-workspace-clis",
        "clickclack": "messaging-workspace-clis",
        "peekaboo": "native-apps-desktop",
        "openclaw-windows-node": "native-apps-desktop",
        "axorcist": "native-apps-desktop",
        "tachikoma": "native-apps-desktop",
        "crabfleet": "native-apps-desktop",
        "nix-openclaw": "packaging-nix-infra",
        "openclaw-ansible": "packaging-nix-infra",
        "homebrew-tap": "packaging-nix-infra",
        "nix-openclaw-tools": "packaging-nix-infra",
...
<title>OpenClaw GitHub Repository Atlas</title>
...
<style>
  ...
  * {{ box-sizing: border-box; }}
  ...
  body {{
    ...
    min-height: 100vh;
    background:
      radial-gradient(circle at 85% -10%, rgba(255, 90, 60, 0.22), transparent 28rem),
      radial-gradient(circle at 8% 4%, rgba(251, 191, 36, 0.1), transparent 26rem),
      linear-gradient(180deg, #1a120e 0%, var(--bg) 42rem);
    color: var(--text);
  ...
  .logo-box {{
    ...
    color: #1a0c08;
    font-weight: 800;
    box-shadow: 0 0 24px rgba(255, 90, 60, 0.32);
  }}
  ...
  .jump-group-clusters a {{
    border-color: rgba(255, 90, 60, 0.34);
  ...
  .search-panel {{
    ...
    border-radius: 12px;
    background:
      radial-gradient(circle at top right, rgba(255, 90, 60, 0.14), transparent 24rem),
  ...
  .search-input:focus {{
    border-color: rgba(255, 90, 60, 0.82);
  ...
  tbody tr:hover {{ background: rgba(255, 90, 60, 0.045); }}
  ...
  .activity-bar span {{
    ...
    background: linear-gradient(90deg, #ff5a3c, #ff8a4c);
  }}
  ...
  .footer a {{ color: var(--openclaw); text-decoration: none; }}
...
{extra_section_html}
  ...
  <footer class="footer">
    <p style="margin-bottom: 10px;">Useful links:
      <a class="gh-link" href="https://openclaw.ai/" target="_blank" rel="noreferrer" style="display: inline; margin-left: 6px;">openclaw.ai</a>
