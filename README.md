...
The seven clusters cover the core assistant, skills and plugins, agent
protocols, review automation, messaging and workspace CLIs, native macOS/Windows
apps, and packaging/Nix infrastructure.
...
- `favicon.svg` - OpenClaw-themed favicon.
...
- `cloudflare/worker.js` - proxies the site at `https://glaubi.net/openclaw`.
